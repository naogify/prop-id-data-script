...
describe('分類テスト', () => {
  ...
  test('1つの住所に、複数の建物と1つの建物で分類', async () => {
    ...
    const singleBuilding = [ [ 'ライオンズマンション浦和元町', '埼玉県さいたま市浦和区元町一丁目33-15' ] ]
    const multiBuildings = [
      [ 'パークスクエア浦和常盤', '埼玉県さいたま市浦和区常盤一丁目49-1' ],
      [ 'パークスクエア浦和常磐', '埼玉県さいたま市浦和区常盤一丁目49-1' ],
      [ 'ファイン ブルーム', '神奈川県茅ヶ崎市本宿町1-30' ],
      [ 'ファイン ブルームⅵ', '神奈川県茅ヶ崎市本宿町1-30' ],
      [ 'ファイン ブルームⅥ', '神奈川県茅ヶ崎市本宿町1-30' ]
    ]
